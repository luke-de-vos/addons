...
SWEP.HoldType         = "smg"                    -- "pistol", "revolver", "smg", "rifle", or "shotgun"
...
SWEP.CanSprint        = false -- Allow sprinting to holster the weapon?
SWEP.CanNearWall      = false -- Allow being near a wall to holster the weapon?
