...
-- 			if IsValid(ply) and ply:Alive() and IsFirstTimePredicted() then
-- 				local pre_nade_wep = ply:GetActiveWeapon()
-- 				print("pre_nade_wep: ", pre_nade_wep)
-- 				net.Start("QuickNadeAttack"); net.SendToServer()
-- 				timer.Simple(0.3, function()
-- 					if IsValid(ply) and ply:Alive() then
-- 						input.SelectWeapon(pre_nade_wep)
-- 					end
-- 				end)
--             	return true
-- 			end
--         end
--     end)
-- 	-- hook.Remove("PlayerButtonDown", "QuickNadeKey")
-- end
